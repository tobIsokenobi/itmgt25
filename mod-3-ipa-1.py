...
def shift_letter(letter, shift):
    ...
    *Note: the single underscore `_` is used to acknowledge the presence
    ...
    if letter == ' ':
     ...
     boom = boom + chr((ord(letter) + shift - 65)% 26 + 65)
    else:
     boom = boom + chr((ord(letter) + shift - 97)% 26 + 97)
...
def caesar_cipher(message, shift):
    ...
    for char in message: 
        if char == ' ':
            ...
            boom = boom + chr((ord(char) + shift - 65) % 26 + 65)
        else:
            boom = boom + chr((ord(char) + shift - 97) % 26 + 97)
